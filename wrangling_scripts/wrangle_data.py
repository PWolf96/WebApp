...
# fourth chart shows rural population vs arable land
    ...
    df_one = cleandata('data\API_SP.RUR.TOTL_DS2_en.csv_v2_9914824.csv', keepcolumns, valuevariables)
    df_two = cleandata('data\API_AG.NDF.FRST.K2.DS2_en_csv_v2_9910393.csv', keepcolumns, valuevariables)
    ...
    graph_five = []
    df_five = cleandata('data\API_SP.RUR.TOTL_DS2_en.csv_v2_9914824.csv', ['Country Name', '2015'], ['2015'])
